...
function contactPage() {
  return layout({
    ...
    children: `${pageTitle({ eyebrow: "Contact", h1: "Contact Lucente Corporate.", lead: `Send an enquiry to Lucente Corporate at ${site.email}.` })}
    <section class="section"><div class="container contact-layout"><aside class="info-block"><h2>Direct email</h2><p><a class="text-link" href="mailto:${site.email}">${site.email}</a></p><p class="body-copy">The form sends through a secure server-side endpoint when email delivery is configured. If delivery is unavailable, use the direct email link.</p></aside><form class="contact-form" data-contact-form novalidate><div class="field hp-field" aria-hidden="true"><label for="company_website">Company website</label><input id="company_website" name="company_website" tabindex="-1" autocomplete="off"></div><div class="field"><label for="name">Name</label><input id="name" name="name" required minlength="2" maxlength="80" autocomplete="name"><p class="field-error" data-error-for="name"></p></div><div class="field"><label for="email">Email</label><input id="email" name="email" type="email" required maxlength="120" autocomplete="email"><p class="field-error" data-error-for="email"></p></div><div class="field"><label for="enquiryType">Enquiry type</label><select id="enquiryType" name="enquiryType" required><option value="">Select an enquiry type</option><option>General enquiry</option><option>Website or app project</option><option>Lucente Calendar</option><option>Lucente QR</option><option>Lucente Admin</option><option>Partnership or collaboration</option></select><p class="field-error" data-error-for="enquiryType"></p></div><div class="field"><label for="message">Message</label><textarea id="message" name="message" required minlength="20" maxlength="2000"></textarea><p class="field-error" data-error-for="message"></p></div><label class="checkbox"><input type="checkbox" name="consent" required> <span>I agree that Lucente Corporate may use my submitted details to respond to this enquiry. I have read the <a class="text-link" href="/privacy/">Privacy Policy</a>.</span></label><p class="field-error" data-error-for="consent"></p><button class="button primary" type="submit" data-submit-button>Send Enquiry</button><p class="form-note" data-form-note aria-live="polite"></p><p class="body-copy">Fallback: <a href="mailto:${site.email}">${site.email}</a></p></form></div></section>`
  });
}
...
function privacyPage() {
  return layout({
    ...
    description: "Privacy information for Lucente Corporate website visitors and contact form submissions.",
    children: `${pageTitle({ eyebrow: "Privacy Policy", h1: "Privacy information for Lucente enquiries.", lead: "Last updated: 17 July 2026." })}
    <section class="section light"><div class="container stack"><article class="info-block"><h2>Information collected</h2><p>The contact form may collect name, email address, enquiry type, message and privacy consent status. A hidden honeypot field is used to reduce spam.</p></article><article class="info-block"><h2>Why information is collected</h2><p>Submitted information is used to respond to enquiries about Lucente Corporate, its services, projects and possible collaborations.</p></article><article class="info-block"><h2>How form submissions are delivered</h2><p>The website includes a server-side Vercel function prepared to send enquiry emails through Resend when the required environment variables are configured. If it is not configured, visitors can use the direct email link to contact ${site.email}.</p></article><article class="info-block"><h2>Hosting logs and third-party services</h2><p>The website is hosted on Vercel, which may process technical hosting logs needed to operate and protect the site. No analytics package is present in this repository.</p></article><article class="info-block"><h2>Retention and control</h2><p>Enquiries may be retained for a reasonable period to respond and keep project context. To request access or deletion, email <a class="text-link" href="mailto:${site.email}">${site.email}</a>.</p></article><article class="info-block"><h2>Important limits</h2><p>Lucente Corporate does not sell submitted personal information. Users should not submit sensitive personal information through the form.</p></article></div></section>`
  });
}
